    ...
    return (
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button className="w-full my-4 flex cursor-pointer gap-2" variant="outline" asChild>
                    <a href="http://localhost:8081/oauth2/authorization/google">
                        <svg className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30">

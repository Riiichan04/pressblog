...
export default function CommentList({ filterStatus, postSlug, onClearPostFilter }: CommentListProps) {
    ...
    const handleUpdateStatus = async (id: number, newStatus: string) => {
        ...
        try {
            ...
            toast.success(t("comments.messages.statusUpdateSuccess")); // 🎯 Dùng i18n
    ...
    const handleRestore = async (id: number) => {
        ...
        try {
            ...
            toast.success(t("comments.messages.restoreSuccess")); // 🎯 Dùng i18n
    ...
    // 🎯 Hàm render Badge sạch sẽ và chuẩn i18n
